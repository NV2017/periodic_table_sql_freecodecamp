...
--
-- Name: elements c_e_n_u; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT c_e_n_u UNIQUE (name);


--
-- Name: elements c_e_s_u; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT c_e_s_u UNIQUE (symbol);
...
--
-- Name: properties fk_an_p_e_an; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_an_p_e_an FOREIGN KEY (atomic_number) REFERENCES public.elements(atomic_number);


--
-- Name: properties fk_p_ti_t_ti; Type: FK CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.properties
    ADD CONSTRAINT fk_p_ti_t_ti FOREIGN KEY (type_id) REFERENCES public.types(type_id);
